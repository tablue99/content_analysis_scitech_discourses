...
**ACHTUNG**: Eine Aussage kann nicht mehrere Absätze umfassen. Mit jedem neuen Absatz wird, falls vorhanden, eine neue Aussage codiert. Aufgrund der Darstellung in der App ist dies oftmals schwierig zu beurteilen, daher sollen im Zweifel lieber zu viele als zu wenige Aussagen codiert werden. Ist in der App ersichtlich, dass eine Aussage in einer Zwischenüberschrift oder im Teaser steht (i. d. R. daran ersichtlich, dass sie später nochmal genauso bzw. unparaphrasiert wiederholt wird), wird sie an dieser Stelle nicht codiert, sondern erst wenn sie im Fließtext erscheint.
